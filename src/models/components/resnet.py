...
'''
Based on https://pytorch-tutorial.readthedocs.io/en/latest/tutorial/chapter03_intermediate/3_2_2_cnn_resnet_cifar10/
'''
...
class ResNet4(nn.Module):
    def __init__(self, layers, num_classes=10):
        ...
        self.layer2 = self.make_layer(ResidualBlock, 32, layers[1], 2)
        self.layer3 = self.make_layer(ResidualBlock, 64, layers[2], 2)
        self.layer4 = self.make_layer(ResidualBlock, 128, layers[3], 2)
